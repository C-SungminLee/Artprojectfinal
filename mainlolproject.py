...
wn.addshape('R6W96UC-removebg-preview.gif')
powerupcounter1 = trtl.Turtle()
powerupcounter1.hideturtle()
powerupcounter1.shape('R6W96UC-removebg-preview.gif')
...
def attack():
    ...
    if v == False:
        ...
        if powerupchecker == True:
            ...
            powerupcounter1.hideturtle()
            winsound.PlaySound("smb_1-up.wav", winsound.SND_ALIAS)
        ...
        g_a.speed(0.51)
        g_a.showturtle()
        winsound.PlaySound("sf_cannon_01.wav", winsound.SND_ASYNC)
        ...
        if int(ufo.xcor()-50)<g_a.xcor()<int(ufo.xcor()+50) and  100<g_a.ycor()<300:
            ...
            winsound.PlaySound("sf_explosion_20-_1_.wav", winsound.SND_ALIAS)            
            time.sleep(0.1)
